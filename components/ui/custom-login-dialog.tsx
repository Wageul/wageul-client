...
const AlertDialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col justify-end pb-[50px] space-y-2 text-center sm:text-left",
      className
    )}
    {...props}
  />
